...
const Contact = () => {
  ...
  <i className="fa-solid fa-droplet"></i>
      ...
      <section className="contactStrip">
        ...
        <a
          href="mailto:srishtisonawane6@gmail.com"
        ...
        > 
          ...
          <div>
            <small>EMAIL</small>
            <strong>srishtisonawane6@gmail.com</strong>
          </div>
      ...
      <section className="emergencySection">
        ...
        <div className="emergencyLeft">
          ...
          <div>
            <span>URGENT BLOOD REQUIREMENT?</span>
            ...
            <p>
              If you need blood urgently, contact our team with the
              required blood group and location details.
            </p>
          </div>
        </div>
      ...
      <section className="community">
        ...
        <div className="communityHeading">
          ...
          <p>
            BloodCare brings together donors, volunteers and people
            who believe that helping another person can change a life.
          </p>
        ...
        <div className="communityGrid">
          ...
          <div className="communityImage largeImage">
            <img
              src="/photo8.jpg"
              alt="Blood care"
            />
